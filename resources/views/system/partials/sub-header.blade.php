						...
						<div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap">
                                    @if(isset($add_new) && ( staffCan($add_new['route'].'?func=create') || staffCan($add_new['route'])  ) )
                                        <a href="{{route($add_new['route'],['func'=>'create'])}}" class="btn btn-primary mr-3">
                                    ...
                                    @endif
                                    @if(isset($download_excel) && $download_excel == true)
                                        <a @if(isset($export_type) && $export_type == 'front')  id="ExportReporttoExcel" @else onclick="filterFunction($('#filterForm'),true)" @endif title="{{__('Download Excel')}}" href="javascript:;"  class="btn btn-icon btn-outline-primary mr-2">
