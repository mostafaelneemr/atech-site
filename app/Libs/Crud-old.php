...
//                dd($this->display_as,$columns);
    ...
    {
//dd($this->change_field_type['title']);
        ...
        return view( 'crud.show', compact( 'data', 'display_as','change_field_type' ) );
    }
    ...
    function show_create_page()
    {
        ...
        return view( 'crud.create', compact( 'fields', 'display_as','route_name' ) );
    }
    ...
    function show_edit_page($id)
    {
        ...
        $display_as = $this->display_as;
        $route_name = $this->route_name;
        return view( 'crud.create', compact( 'result', 'display_as', 'fields','route_name' ) );
    }
...
//                    dd($request,$file,$key);
                    if (in_array( $key, $this->getFields() )) {
                       // $request->file('avatar')->store(setting('system_path').'/avatar/'.date('Y/m/d'),'first_public');
                        $data[$key] =$file->store( 'uploaded_files/' . date( 'y' ) . '/' . date( 'm' ) );
                    }
                }
            }
